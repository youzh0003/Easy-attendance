...
public class UpdateGroupUseCase extends CompletableUseCase<UpdateGroupUseCase.Params> {
    ...
    @Inject
    UpdateGroupUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, GroupRepository groupRepository) {
    ...
    Completable buildUseCaseObservable(Params params) {
        return groupRepository.updateGroup(params.group);
    }
